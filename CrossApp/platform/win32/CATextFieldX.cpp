...
{
	friend class CATextFieldX;
public:
	CATextFieldWin32(CATextFieldX* e)
		: m_pTextFieldX(e)
		, m_pCursorMark(NULL)
	...
	int getDtStrLength()
	{
		...
		{
			const CATextFieldX::TextFieldAlign& align = m_pTextFieldX->getTextFieldAlign();
			switch (align)
			{
	...
	void updateImage()
	{
		...
		{
			text = m_sText;
			cFontColor = m_pTextFieldX->getFieldTextColor();
		}
		...
		const int& fontSize = m_pTextFieldX->getFontSize();
	...
	void updateImageRect()
	{
		...
		const CATextFieldX::TextFieldAlign& align = m_pTextFieldX->getTextFieldAlign();
		if (align == CATextFieldX::TextEditAlignRight)
		{
			x1 = m_iLabelWidth - m_obRect.size.width;
		}
		else if (align == CATextFieldX::TextEditAlignCenter)
		{
...
, m_marginLeft(10)
, m_marginRight(10)
, m_clearBtn(ClearButtonMode::ClearButtonWhileEditing)
{
...
void CATextFieldX::setTextFieldAlign(const TextFieldAlign& e)
{
	m_align = e;
...
{
	m_fieldText = ((CATextFieldWin32*)m_pTextField)->getText();
	return m_fieldText;
}
