...
#ifndef __CA_FILEUTILS_H__
#define __CA_FILEUTILS_H__
...
public:
     ...
     *  @since v2.1
     */
    virtual void setFilenameLookupDictionary(const CAValueMap& filenameLookupDict);
     ...
     */
    virtual CAValueMap getValueMapFromFile(const std::string& filename);


    /** Converts the contents of a file to a ValueMap.
     *  This method is used internally.
     */
    virtual CAValueMap getValueMapFromData(const char* filedata, int filesize);
    ...
    *@return bool
    */
    virtual bool writeToFile(const CAValueMap& dict, const std::string& fullPath);
    ...
    *@return bool
    */
    virtual bool writeValueMapToFile(const CAValueMap& dict, const std::string& fullPath);
    ...
    *@return bool
    */
    virtual bool writeValueVectorToFile(const CAValueVector& vecData, const std::string& fullPath);
    ...
    */
    ...
    // This method is used internally.
    virtual CAValueVector getValueVectorFromFile(const std::string& filename);
...
protected:
     ...
     *  @since v2.1
     */
    CAValueMap _filenameLookupDict;
