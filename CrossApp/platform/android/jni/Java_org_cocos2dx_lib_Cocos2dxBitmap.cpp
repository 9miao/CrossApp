...
int getFontSizeAccordingHeightJni(int height) {
    ...
    JniMethodInfo t;
    if (JniHelper::getStaticMethodInfo(t, "org/CrossApp/lib/Cocos2dxBitmap", "getFontSizeAccordingHeight", "(I)I")) {
...
std::string getStringWithEllipsisJni(const char* pszText, float width, float fontSize) {
    ...
    if (JniHelper::getStaticMethodInfo(t, "org/CrossApp/lib/Cocos2dxBitmap", "getStringWithEllipsis", "(Ljava/lang/String;FF)Ljava/lang/String;")) {
        jstring stringArg1;
