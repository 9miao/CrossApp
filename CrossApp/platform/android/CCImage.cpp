...
public:
    									...
    									float strokeSize 		= 0.0 )
    {
           ...
           if (! JniHelper::getStaticMethodInfo(methodInfo, "org/CrossApp/lib/Cocos2dxBitmap", "createTextBitmapShadowStroke",
...
extern "C"
{
    ...
    */
    JNIEXPORT void JNICALL Java_org_CrossApp_lib_Cocos2dxBitmap_nativeInitBitmapDC(JNIEnv*  env, jobject thiz, int width, int height, jbyteArray pixels)
    {
        int size = width * height * 4;
        CrossApp::BitmapDC& bitmapDC = CrossApp::sharedBitmapDC();
