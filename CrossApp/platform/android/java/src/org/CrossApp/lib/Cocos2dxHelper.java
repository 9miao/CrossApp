...
public class Cocos2dxHelper {
	...
	private static void showToast(final String pMessage, final int pFlag) {
		Cocos2dxHelper.sCocos2dxHelperListener.showToast(pMessage, pFlag);
	}
	...
	public static interface Cocos2dxHelperListener {
		...
		public void showToast(final String pMessage, final int pFlag);
