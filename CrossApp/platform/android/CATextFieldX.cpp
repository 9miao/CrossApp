...
void setClearButtonJNI(int key, int size)
{
	JniMethodInfo jni;
	if (JniHelper::getStaticMethodInfo(jni, CLASS_NAME, "getTextField", GET_CLASS))
	{
		...
		if (JniHelper::getMethodInfo(jni, CLASS_NAME, "setClearBtn", "(I)V"))
		{
