...
/**
 @file
 CrossApp (cc) configuration file
*/
...
/** @def CC_ENABLE_GL_STATE_CACHE
 If enabled, CrossApp will maintain an OpenGL state cache internally to avoid unnecessary switches.
...
#define CC_DIRECTOR_FPS_POSITION DPoint(0,0)
#endif
...
If enabled, CrossApp-mac will run on the Display Link thread. If disabled CrossApp-mac will run in its own thread.
...
Only valid for CrossApp-mac. Not supported on CrossApp-ios.
...
/** @def CC_NODE_RENDER_SUBPIXEL
 If enabled, the CAView objects (CCSprite, CCLabel,etc) will be able to render in subpixels.
...
/** @def CC_TEXTURE_ATLAS_USE_VAO
 By default, CCTextureAtlas (used by many CrossApp classes) will use VAO (Vertex Array Objects).
...
/** @def CC_ENABLE_PROFILERS
 If enabled, will activate various profilers within CrossApp. This statistical data will be output to the console
