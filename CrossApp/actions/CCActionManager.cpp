...
void CCActionManager::pauseTarget(CAObject *pTarget)
{
...
void CCActionManager::resumeTarget(CAObject *pTarget)
{
    tHashElement *pElement = NULL;
    HASH_FIND_INT(m_pTargets, &pTarget, pElement);
    if (pElement)
...
void CCActionManager::resumeTargets(CrossApp::CCSet *targetsToResume)
{    
    CCSetIterator iter;
...
void CCActionManager::removeAllActions(void)
{
    ...
    {
        CAObject *pTarget = pElement->target;
...
void CCActionManager::removeAction(CCAction *pAction)
{
    ...
    tHashElement *pElement = NULL;
    CAObject *pTarget = pAction->getOriginalTarget();
    HASH_FIND_INT(m_pTargets, &pTarget, pElement);
    if (pElement)
    {
...
unsigned int CCActionManager::numberOfRunningActionsInTarget(CAObject *pTarget)
{
    tHashElement *pElement = NULL;
    HASH_FIND_INT(m_pTargets, &pTarget, pElement);
    if (pElement)
