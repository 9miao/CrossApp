...
public:
     ...
     */
    static void createLookAt(const DPoint3D& eyePosition, const DPoint3D& targetPosition, const DPoint3D& up, Mat4* dst);
     ...
     * @param dst A matrix to store the result in.
     */
    static void createBillboard(const DPoint3D& objectPosition, const DPoint3D& cameraPosition,
     ...
     * @param dst A matrix to store the result in.
     */
    static void createScale(const DPoint3D& scale, Mat4* dst);
     ...
     * @param dst A matrix to store the result in.
     */
    static void createRotation(const DPoint3D& axis, float angle, Mat4* dst);
     ...
     * @param dst A matrix to store the result in.
     */
    static void createTranslation(const DPoint3D& translation, Mat4* dst);
     ...
     * @param translation The translation.
     */
    bool decompose(DPoint3D* scale, Quaternion* rotation, DPoint3D* translation) const;
     ...
     */
    void getScale(DPoint3D* scale) const;
     ...
     */
    void getTranslation(DPoint3D* translation) const;
     ...
     */
    void getUpVector(DPoint3D* dst) const;
     ...
     * @param dst The destination vector.
     */
    void getDownVector(DPoint3D* dst) const;
     ...
     * @param dst The destination vector.
     */
    void getLeftVector(DPoint3D* dst) const;
     ...
     * @param dst The destination vector.
     */
    void getRightVector(DPoint3D* dst) const;
     ...
     * @param dst The destination vector.
     */
    void getForwardVector(DPoint3D* dst) const;
     ...
     * @param dst The destination vector.
     */
    void getBackVector(DPoint3D* dst) const;
     ...
     * @param angle The angle (in radians).
     */
    void rotate(const DPoint3D& axis, float angle);
     ...
     * @param dst A matrix to store the result in.
     */
    void rotate(const DPoint3D& axis, float angle, Mat4* dst) const;
     ...
     * @param dst A matrix to store the result in.
     */
    void scale(const DPoint3D& s, Mat4* dst) const;
     ...
     */
    inline void transformPoint(DPoint3D* point) const { GP_ASSERT(point); transformVector(point->x, point->y, point->z, 1.0f, point); }
     ...
     */
    inline void transformPoint(const DPoint3D& point, DPoint3D* dst) const { GP_ASSERT(dst); transformVector(point.x, point.y, point.z, 1.0f, dst); }
     ...
     */
    void transformVector(DPoint3D* vector) const;
     ...
     */
    void transformVector(const DPoint3D& vector, DPoint3D* dst) const;
     ...
     * @param dst A vector to store the transformed point in.
     */
    void transformVector(float x, float y, float z, float w, DPoint3D* dst) const;
     ...
     */
    void translate(const DPoint3D& t);
     ...
     * @param dst A matrix to store the result in.
     */
    void translate(const DPoint3D& t, Mat4* dst) const;
...
private:
    ...
    static void createBillboardHelper(const DPoint3D& objectPosition, const DPoint3D& cameraPosition,
                                      const DPoint3D& cameraUpVector, const DPoint3D* cameraForwardVector,
                                      Mat4* dst);
};
