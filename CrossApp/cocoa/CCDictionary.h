...
private:
     ...
     */
    CCDictElement(const char* pszKey, CAObject* pObject);
     ...
     *  @param  pObject   The object of this element.
     */
    CCDictElement(intptr_t iKey, CAObject* pObject);
...
public:
     ...
     */
    inline CAObject* getObject() const { return m_pObject; }
 ...
 *
 *  @note Only the pointer of CAObject or its subclass can be inserted to CCDictionary.
 *  @code
...
class CC_DLL CCDictionary : public CAObject
{
public:
    /** 
     ...
     */
    CCArray* allKeysForObject(CAObject* object);
     ...
     */
    CAObject* objectForKey(const std::string& key);
     ...
     */
    CAObject* objectForKey(intptr_t key);
     ...
     *  @param key      The string key for searching.
     *  @see setObject(CAObject*, intptr_t)
     */
    void setObject(CAObject* pObject, const std::string& key);
     ...
     *  @param pObject  The Object to be inserted.
     *  @param key      The string key for searching.
     *  @see setObject(CAObject*, const std::string&)
     */
    void setObject(CAObject* pObject, intptr_t key);
     ...
     *  You shouldn't invoke this function manually since it's called by CAObject::copy.
     *  @lua NA
     *  @js  NA
     */
...
private:
     ...
     */
    void setObjectUnSafe(CAObject* pObject, const std::string& key);
    void setObjectUnSafe(CAObject* pObject, const intptr_t key);
