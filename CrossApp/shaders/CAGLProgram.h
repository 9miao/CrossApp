...
#ifndef __CAGLProgram_H__
#define __CAGLProgram_H__
...
/** CAGLProgram
 ...
 @since v2.0.0
 */
class CC_DLL CAGLProgram : public CAObject
{
public:
    /**
     * @js  ctor
     ...
     */
    virtual ~CAGLProgram();
    /** Initializes the CAGLProgram with a vertex and fragment with bytes array 
     * @js  initWithString
     * @lua NA
     */
...
#endif
    /** Initializes the CAGLProgram with a vertex and fragment with contents of filenames 
     * @js  init
     * @lua NA
     */
