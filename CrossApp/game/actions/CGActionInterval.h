...
public:
...
#else
    static Sequence* create(FiniteTimeAction *action1, ...) M_REQUIRES_NULL_TERMINATION;
#endif
     ...
     * @return An autoreleased Sequence object.
     */
    static Sequence* create(const CAVector<FiniteTimeAction*>& arrayOfActions);
...
public:
    ...
    bool init(const CAVector<FiniteTimeAction*>& arrayOfActions);
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(Sequence);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(Repeat);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(RepeatForever);
};
...
public:
...
#else
    static Spawn* create(FiniteTimeAction *action1, ...) M_REQUIRES_NULL_TERMINATION;
#endif
     ...
     * @return  An autoreleased Spawn object.
     */
    static Spawn* create(const CAVector<FiniteTimeAction*>& arrayOfActions);
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(Spawn);
};
...
public:
     ...
     * @param duration Duration time, in seconds.
     * @param dstAngle3D A DPoint3D angle.
     * @return An autoreleased RotateTo object.
     */
    static RotateTo* create(float duration, const DPoint3D& dstAngle3D);
...
public:
     ...
     * @param duration in seconds
     */
    bool initWithDuration(float duration, const DPoint3D& dstAngle3D);
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(RotateTo);
};
...
public:
     ...
     *
     * @param duration Duration time, in seconds.
     * @param deltaAngle3D A DPoint3D angle.
     * @return An autoreleased RotateBy object.
     */
    static RotateBy* create(float duration, const DPoint3D& deltaAngle3D);
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(RotateBy);
};
...
public:
     ...
     *
     * @param duration Duration time, in seconds.
     * @param deltaPosition The delta distance in 2d, it's a DPoint type.
     * @return An autoreleased MoveBy object.
     */
    static MoveBy* create(float duration, const DPoint& deltaPosition);
    /**
     * Creates the action.
     *
     * @param duration Duration time, in seconds.
...
protected:
    bool _is3D;
    DPoint3D _positionDelta;
    DPoint3D _startPosition;
    DPoint3D _previousPosition;

private:
    M_DISALLOW_COPY_AND_ASSIGN(MoveBy);
};
...
public:
     ...
     */
    static MoveTo* create(float duration, const DPoint& position);
    /**
     * Creates the action.
     * @param duration Duration time, in seconds.
...
public:
     ...
     * @param duration in seconds
     */
    bool initWithDuration(float duration, const DPoint& position);
    /**
     * initializes the action
     * @param duration in seconds
     */
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(MoveTo);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(SkewTo);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(SkewBy);
};
...
public:
     ...
     */
    static JumpBy* create(float duration, const DPoint& position, float height, int jumps);
...
public:
     ...
     * @param duration in seconds
     */
    bool initWithDuration(float duration, const DPoint& position, float height, int jumps);

protected:
    DPoint           _startPosition;
    DPoint           _delta;
    float           _height;
    int             _jumps;
    DPoint           _previousPos;
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(JumpBy);
};
...
public:
     ...
     */
    static JumpTo* create(float duration, const DPoint& position, float height, int jumps);
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(JumpTo);
};
...
typedef struct _ccBezierConfig {
    ...
    DPoint controlPoint_1;
    //! Bezier control point 2
    DPoint controlPoint_2;
} ccBezierConfig;
...
protected:
    ...
    DPoint _startPosition;
    DPoint _previousPosition;

private:
    M_DISALLOW_COPY_AND_ASSIGN(BezierBy);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(BezierTo);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(ScaleTo);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(ScaleBy);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(Blink);
};
...
protected:
    ...
    friend class FadeIn;
private:
    M_DISALLOW_COPY_AND_ASSIGN(FadeTo);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(FadeIn);
...
public:
    ...
    virtual ~FadeOut() {}
private:
    M_DISALLOW_COPY_AND_ASSIGN(FadeOut);
    FadeTo* _reverseAction;
};
...
public:
     ...
     * Creates an action with duration and color.
     * @param duration Duration time, in seconds.
     * @param color It's a CAColor4B type.
     * @return An autoreleased TintTo object.
     */
    static TintTo* create(float duration, const CAColor4B& color);
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(TintTo);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(TintBy);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(DelayTime);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(ReverseTime);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(Animate);
};
...
private:
    M_DISALLOW_COPY_AND_ASSIGN(ActionFloat);
};
