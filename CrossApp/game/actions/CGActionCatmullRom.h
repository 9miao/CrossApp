...
public:
     ...
     */
    void addControlPoint(DPoint controlPoint);
     ...
     */
    void insertControlPoint(DPoint &controlPoint, ssize_t index);
     ...
     */
    void replaceControlPoint(DPoint &controlPoint, ssize_t index);
     ...
     * @return A DPoint.
     */
    DPoint getControlPointAtIndex(ssize_t index);
     ...
     * @js NA
     */
    const std::vector<DPoint*>* getControlPoints() const;
    /**
     * @js NA
     */
    void setControlPoints(std::vector<DPoint*> *controlPoints);
private:
    /** Array that contains the control points. */
    std::vector<DPoint*> *_controlPoints;
};
...
public:
     ...
     */
    virtual void updatePosition(DPoint &newPos);
    /** Return a PointArray.
     *
     * @return A PointArray.
     */
