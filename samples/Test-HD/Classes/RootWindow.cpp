...
bool RootWindow::init()
{
    ...
    ///////---------------//////////////
    CAVector<CrossApp::CAViewController *> vec;
    vec.pushBack(_menuview);
    vec.pushBack(m_pRootNavigationController);
    CASplitViewController* drawer = new CASplitViewController();
    vector<unsigned int> widths;
    widths.push_back(winSize.width/4);
    widths.push_back(winSize.width/2);
    drawer->initWithController(vec, widths);
    ///////---------------//////////////
