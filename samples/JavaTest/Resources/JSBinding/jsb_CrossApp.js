...
ca.POINT_ZERO = {x:0, y:0};
ca.RECT_ZERO = {x:0, y:0, width:0, height:0};
ca.SIZE_ZERO = {width:0, height:0}
//KeyBoardInputType
KEY_BOARD_TYPE_NORMAL = 0;
KEY_BOARD_TYPE_NUMBER = 1;
KEY_BOARD_TYPE_ALPHABET = 2;
//KeyBoardInputType
KEY_BOARD_INPUT_NORMAL = 1;
KEY_BOARD_INPUT_PASSWORD = 2;
//KeyBoardReturnType
KEY_BOARD_RETURN_DONE = 21;
KEY_BOARD_RETURN_SEARCH = 22;
KEY_BOARD_RETURN_SEND = 23;

//Btn Type
ca.BUTTONTYPECUSTOM = 0;
ca.BUTTONTYPESQUARERECT = 1;
ca.BUTTONTYPEROUNDEDRECT = 2;

ca.ControlEventTouchDown = 0;
ca.ControlEventTouchDownRepeat = 1;
ca.ControlEventTouchMoved = 2;
ca.ControlEventTouchMovedOutSide = 3;
ca.ControlEventTouchUpInSide = 4;
ca.ControlEventTouchUpSide = 5;
ca.ControlEventTouchValueChanged = 6;

ca.ControlStateNormal = 0;
ca.ControlStateHighlighted = 1;
ca.ControlStateDisabled = 2;
ca.ControlStateSelected = 3;
ca.ControlStateAll = 4;

ca.VerticalTextAlignmentTop = 0;
ca.VerticalTextAlignmentCenter = 1;
ca.VerticalTextAlignmentBottom = 2;

ca.TextAlignmentLeft = 0;
ca.TextAlignmentCenter = 1;
ca.TextAlignmentRight = 2;
...
ca.ViewController.extend = cc.Class.extend;
ca.JSViewController.extend = cc.Class.extend;
//ca.CCApplication.extend = cc.Class.extend;
