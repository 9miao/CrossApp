...
def do_build(crossapp_root, ndk_root, app_android_root,ndk_build_param,sdk_root,android_platform,build_mode):
    ...
    if os.system(command) != 0:
        raise Exception("Build dynamic library for project [ " + app_android_root + " ] fails!")
    	  ...
    	  crossapplib_path = os.path.join(crossapp_root, "CrossApp/platform/android/java")
    	  command = '%s update lib-project -t %s -p %s' % (sdk_tool_path,android_platform,crossapplib_path) 
    	  if os.system(command) != 0:
    	  	  raise Exception("update cocos lib-project [ " + crossapplib_path + " ] fails!")  	  
...
def build(ndk_build_param,android_platform,build_mode):
    ...
    crossapp_root = os.path.join(current_dir, "../../../CrossApp")
    ...
    do_build(crossapp_root, ndk_root, app_android_root,ndk_build_param,sdk_root,android_platform,build_mode)
