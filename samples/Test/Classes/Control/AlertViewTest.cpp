...
void AlertViewTest::viewDidLoad()
{
    ...
    btn1->setLayout(DRectLayout(240,240,200,60,DRectLayout::L_R_T_H));
    btn1->setTag(100);
    ...
    btn2->setLayout(DRectLayout(240,240,400,60,DRectLayout::L_R_T_H));
    btn2->setTag(200);
    ...
    btn3->setLayout(DRectLayout(240,240,600,60,DRectLayout::L_R_T_H));
    btn3->setTag(300);
