...
void ActivityIndicatorViewTest::viewDidLoad()
{
    ...
    CAActivityIndicatorView* idc1 = CAActivityIndicatorView::createWithLayout(DLayout(0,0,0,0,DLayout::L_R_T_B));
    ...
    CAActivityIndicatorView* idc2 = CAActivityIndicatorView::createWithLayout(DLayout(0,0,0,0,DLayout::L_R_T_B));
    ...
    CAActivityIndicatorView* idc3 = CAActivityIndicatorView::createWithLayout(DLayout(0,0,0,0,DLayout::L_R_T_B));
    ...
    CAActivityIndicatorView* idc4 = CAActivityIndicatorView::createWithLayout(DLayout(0,0,0,0,DLayout::L_R_T_B));
...
//    CAImageView* imageView = CAImageView::createWithCenter(DRect(0, 0, 100, 100));
    CAImageView* imageView = CAImageView::createWithLayout(DLayout(100,100,100,100,DLayout::L_W_T_H));
    imageView->setFrame(DRect(0, 0, 100, 100));
    imageView->setImage(image);
    CCLog("imageeView.w = ");
    CAActivityIndicatorView* idc5 = CAActivityIndicatorView::createWithLayout(DLayout(100,100,100,100,DLayout::L_R_T_B));
