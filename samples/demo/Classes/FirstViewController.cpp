...
void FirstViewController::viewDidLoad()
{
    ...
    CAButton* btn = CAButton::createWithCenter(CCRect(size.width/2, size.height - off_Y, 150 * CROSSAPP_ADPTATION_RATIO, 60 * CROSSAPP_ADPTATION_RATIO), CAButtonTypeRoundedRect);
