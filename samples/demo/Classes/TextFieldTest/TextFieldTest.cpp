...
void TextFieldTest::viewDidLoad()
{
	...
	textField1->setBackGroundImage(CAImage::create("source_material/ex1.png"));
	...
	textField2->setBackGroundImage(CAImage::create("source_material/btn_rounded3D_selected.png"));
	...
	textField3->setBackGroundImage(CAImage::create("source_material/ex3.png"));
