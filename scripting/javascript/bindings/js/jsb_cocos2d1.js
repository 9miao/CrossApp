...
// Color 4B
//
ca.c4b = function (r, g, b, a) {
    return {r:r, g:g, b:b, a:a };
};

ca._c4b = function( r, g, b, a )
{
    ca._reuse_color4b.r = r;
    ca._reuse_color4b.g = g;
    ca._reuse_color4b.b = b;
    ca._reuse_color4b.a = a;
...
ca.ViewController.extend = ca.Class.extend;
//ca.Layer.extend = cc.Class.extend;
//ca.LayerGradient.extend = cc.Class.extend;
//ca.LayerColor.extend = cc.Class.extend;
//ca.Sprite.extend = cc.Class.extend;
//ca.MenuItemFont.extend = cc.Class.extend;
//ca.Scene.extend = cc.Class.extend;
//ca.DrawNode.extend = cc.Class.extend;
