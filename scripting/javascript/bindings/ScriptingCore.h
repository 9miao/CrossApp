...
class SimpleRunLoop : public CAObject
{
public:
	void update(float d);
};
...
public:
     ...
     */
    virtual void removeScriptObjectByCCObject(CAObject* pObj);
    ...
    virtual int executeNodeEvent(CAViewController* pNode, int nAction);
   // virtual int executeMenuItemEvent(CCMenuItem* pMenuItem);
    virtual int executeNotificationEvent(CANotificationCenter* pNotificationCenter, const char* pszName);
    virtual int executeCallFuncActionEvent(CCCallFunc* pAction, CAObject* pTarget = NULL);
//    virtual int executeSchedule(int nHandler, float dt, CCNode* pNode = NULL);
    virtual int executeLayerTouchesEvent(CAView* pLayer, int eventType, CCSet *pTouches);
    virtual int executeLayerTouchEvent(CAView* pLayer, int eventType, CATouch *pTouch);
    virtual int executeAccelerometerEvent(CAView* pLayer, CCAcceleration* pAccelerationValue);
    virtual int executeLayerKeypadEvent(CAView* pLayer, int eventType);
    virtual int executeEvent(int nHandler, const char* pEventName, CAObject* pEventSource = NULL, const char* pEventSourceClassName = NULL) { return 0; }
    ...
    bool executeFunctionWithObjectData(CAView *self, const char *name, JSObject *obj);
    ...
    int executeCustomTouchEvent(int eventType,
                                CATouch *pTouch, JSObject *obj, jsval &retval);
    int executeCustomTouchEvent(int eventType,
