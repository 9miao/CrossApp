...
namespace gameswf
{
	...
	{
		// constant pool
		swf_array<int> m_integer;
		swf_array<Uint32> m_uinteger;
		swf_array<double> m_double;
		swf_array<tu_string> m_string;
		swf_array<namespac> m_namespace;
		swf_array< swf_array<int> > m_ns_set;
		swf_array<multiname> m_multiname;
