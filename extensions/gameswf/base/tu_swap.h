...
inline Uint16 gameswf_swap16(Uint16 u)
{ 
	return ((u & 0x00FF) << 8) | 
		((u & 0xFF00) >> 8);
}

inline Uint32 gameswf_swap32(Uint32 u)
{ 
...
inline Uint64 gameswf_swap64(Uint64 u)
{
#ifdef __GNUC__
...
// big-endian machine.
{
	...
	return gameswf_swap64(le_64);	// convert to big-endian.
...
// the bytes around first.
{
	...
	return le_32;
#else	// not _TU_LITTLE_ENDIAN_
	return gameswf_swap32(le_32);	// convert to big-endian.
#endif	// not _TU_LITTLE_ENDIAN_
}
...
// integer in native endianness.
{
	...
	return le_16;
#else	// not _TU_LITTLE_ENDIAN_
	return gameswf_swap16(le_16);	// convert to big-endian.
#endif	// not _TU_LITTLE_ENDIAN_
}
...
{
#if _TU_LITTLE_ENDIAN_
	return gameswf_swap32(le_32);	// convert to little-endian.
#else	// not _TU_LITTLE_ENDIAN_
	return le_32;
#endif	// not _TU_LITTLE_ENDIAN_
}
...
{
#if _TU_LITTLE_ENDIAN_
	return gameswf_swap16(le_16);	// convert to little-endian.
#else	// not _TU_LITTLE_ENDIAN_
	return le_16;
#endif	// not _TU_LITTLE_ENDIAN_
}
